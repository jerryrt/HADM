...
from .whole_cascade_mask_rcnn_vitdet_b_100ep import (
    lr_multiplier,
    model,
    train,
    optimizer,
...
dataloader.train.dataset = L(get_detection_dataset_dicts)(
    names=[
        "global_human_artifact_train_ALL",
        "global_human_artifact_CrowdHuman",
        "global_human_artifact_HCD",
        "global_human_artifact_MHP",
        "global_human_artifact_OCHuman",
        "global_human_artifact_FD",
        "global_human_artifact_coco_train",
    ], 
    filter_empty=False)
...
dataloader.evaluator = L(COCOEvaluator)(
    dataset_name="global_human_artifact_val_ALL",
    output_dir="./cache/large_global_human_artifact_ALL_val",
)
